...
barplot(height=ca_covid19.activos$activos,names.arg=ca_covid19.activos$pais, xlab="País", ylab="Casos activos", main="Casos activos de Covid-19 en países centroamericanos y DOM")
```

```{r}
fallecidos.ordenado <- order(ca_covid19$fallecidos, decreasing=TRUE)
ca_covid19.fallecidos <- ca_covid19[fallecidos.ordenado,]
barplot(height=ca_covid19.fallecidos$fallecidos,names.arg=ca_covid19.fallecidos$pais, xlab="País", ylab="Casos fallecidos", main="Casos fallecidos de Covid-19 en países centroamericanos y DOM")
```
